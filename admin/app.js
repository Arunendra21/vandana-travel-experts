...
(function () {
  ...
  function buildShell() {
    ...
    document.body.innerHTML =
      '<div class="ad-shell"><aside class="ad-side"><div class="ad-side__brand"><img src="/assets/img/logo.png?v=4" alt=""><div><b>Vandana</b><span>Admin Panel</span></div></div>' +
  ...
  function fatal(msg, retryFn) {
    ...
    document.body.innerHTML = '<div class="ad-fatal"><img src="/assets/img/logo.png?v=4" alt=""><h2>Admin Panel</h2><p>' + esc(msg) + '</p><button class="ad-btn ad-btn--pri" id="fatal-retry">' + I.refresh + ' Retry</button></div>';
